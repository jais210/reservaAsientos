...
const reserva = {
    ...
    inicio: () => {
        ...
        $('#bus').html(reserva.distribucionAsientos);
    ...
    buscarDNI: () => {
        ...
        if (reserva.bucarDni.length != 0) {
            $('#listaPasajeros').html(`<div id="tablaPasajero" class='row'>\
            <div id="tablaPasajero" class='col col-xl-2 col-sm-2 text-center'>${reserva.bucarDni[0].nroAsiento}</div>\
            <div id="tablaPasajero" class='col col-xl-5 col-sm-5 text-center'>${reserva.bucarDni[0].nombre}</div>\
            <div id="tablaPasajero" class='col col-xl-2 col-sm-3 text-center'>${reserva.bucarDni[0].dni}</div>\
            </div>`);
        } else {
